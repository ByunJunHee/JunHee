...
<header>
		...
		<form>
			<table border=1>
				<tr>
					<td id="title">아이디</td>
					<td>
						<input type="text" name="id" maxlength="12" required>
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="phone2" required size="1">-
						<input type="text" name="phone2" required size="1">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input style="width:40%; display:inline;" placeholder="우편번호"  type="text" name="addr1" id="addr1">
						<%-- <button type="button">우편번호 찾기</button>--%>
					</td>
 				</tr>
				<tr>
					<td>
						<input style="top:5px; width:90%;" placeholder="도로명 주소" type="text" name="addr2" id="addr2">
					</td>
				</tr>
				<tr>
					<td>
						<input style="width:90%;" placeholder="상세주소" type="text" name="addr3" id="addr3" required>
					</td>
				</tr>
			</table>
			<h3>전체 동의</h3>
	...
	<div>
        <h3>[필수] 이용약관 동의</h3>
        <div>
        	<textarea rows="10" cols="45" style="resize:none" readonly>
제1조(목적)
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
        ...
        <input value="1" type="checkbox" id="check_1" class="normal" />
        <label for ="check_1">동의함</label>
        </p>
    </div>
		<div>
        <h3>[필수] 개인정보 수집 및 이용 동의</h3>
        <div>
            <textarea rows="5" cols="45" style="resize:none" readonly>
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
       		 	...
       		 	<p><span>개인정보 수집 및 이용에 동의하십니까?</span>
       		 	<input value="1" type="checkbox" id="check_2" class="normal" />
...
- 보유 및 이용기간 :
        ...
        <p>
	        ...
	        <input value="1" type="checkbox" id="check_3" class="normal" />
	        <label for = "check_3">동의함</label>
        </p>
    </div>
    <div>
                <span>SMS 수신</span>
                 <input value="T" type="checkbox"  />
                 <label>동의함</label>           
                <span>이메일 수신</span>
                <input value="T" type="checkbox"  />
                <label>동의함</label>
