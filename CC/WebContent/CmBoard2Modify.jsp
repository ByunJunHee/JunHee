...
<script>
	function check(){
		...
		alert("등록합니다.");
			document.frm.action ="<%=request.getContextPath()%>/Board/CmBoard2ModifyAction.do";
	...
	<section>
		...
		<form name="frm">
			<table border="1" class="board2-2" width="600" height="450">
				<tr>
					<th height="5%" >제목</th>
					<td><input type="text" name="FcTitle" id="title" value="<%=cfv.getFcTitle()%>"></td>
				</tr>
				<tr>
					<th height="75%">내용</th>
					<td><textarea name="FcContents"><%=cfv.getFcContents() %></textarea></td>
				</tr>
				<tr>
