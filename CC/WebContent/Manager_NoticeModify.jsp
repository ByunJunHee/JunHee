...
<script>
	function check(){
		...
		alert("등록합니다.");
			document.frm.action ="<%=request.getContextPath()%>/Manager/Manager_NoticeModifyAction.do";
	...
	<section>
		...
		<form name="frm">
			<table border="1" class="board2-2" width="600" height="450">
				<tr>
					<th height="5%" >제목</th>
					<td><input type="text" name="NTitle" id="title" value="<%=cnv.getNTitle()%>"></td>
				</tr>
				<tr>
					<th height="75%">내용</th>
					<td><textarea name="NContents"><%=cnv.getNContents() %></textarea></td>
				</tr>
				<tr>
